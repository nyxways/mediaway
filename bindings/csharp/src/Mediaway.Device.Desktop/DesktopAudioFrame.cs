...
/// <summary>
/// One captured PCM chunk — from <see cref="IDesktopAudioCapture.ReadFramesAsync"/>. Owns
/// the native buffer backing <see cref="Data"/>; dispose when done with it.
/// </summary>
public sealed class DesktopAudioFrame : IDisposable
{
    private readonly IMemoryOwner<byte> _owner;

    internal DesktopAudioFrame(IMemoryOwner<byte> owner) => _owner = owner;
