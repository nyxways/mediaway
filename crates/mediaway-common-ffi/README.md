...
Internal `rlib`-only helper shared by `mediaway-*-ffi` crates ([`mediaway-container-ffi`](../mediaway-container-ffi/README.md), [`mediaway-pipeline-ffi`](../mediaway-pipeline-ffi/README.md), [`mediaway-device-ffi`](../mediaway-device-ffi/README.md)).
