...
//!
//! - [`VideoOutputPreference::CpuFramesOk`](mediaway_decoder::VideoOutputPreference): H.264
...
impl LinuxVideoDecoder {
    ...
    ///
    /// [`VideoOutputPreference::CpuFramesOk`]: mediaway_decoder::VideoOutputPreference::CpuFramesOk
    #[cfg(target_os = "linux")]
