...
use crate::h264_params::H264ParamError;
...
/// `mediaway_decoder::DecodeError` at the public boundary (`DecodeError`
...
pub enum VulkanDecodeError {
    ...
    #[error(transparent)]
    HevcBitstream(#[from] crate::hevc_params::HevcParamError),
