...
//!
//! Owns [`SessionResources`]: every handle a [`crate::decoder::VulkanVideoDecoder`]
...
/// Every handle [`crate::decoder::VulkanVideoDecoder`] allocates on top of the
...
pub(crate) fn create_host_buffer(
    ...
    let type_index = crate::session::find_memory_type(
        memory_properties,
...
pub(crate) fn create_dpb_image(
    ...
    memory_properties: &vk::PhysicalDeviceMemoryProperties,
    profile: &mut crate::session::DecodeProfile,
    format: vk::Format,
