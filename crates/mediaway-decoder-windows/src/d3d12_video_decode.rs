...
//!
//! This is a **different** path than [`crate::wmf`]: that module drives Media
...
//!
//! **Not wired into [`crate::WindowsVideoDecoder`] yet** — this module is self-contained
//! and unregistered; a later integration pass adds `pub mod d3d12_video_decode;` to
//! `src/lib.rs`. It also does **not** implement [`mediaway_decoder::VideoDecoder`] yet:
...
#![allow(
    ...
    module's own #[cfg(test)] tests today (not wired into crate::WindowsVideoDecoder \
...
use mediaway_decoder::{DecodeError, VideoDecoderConfig, VideoOutputPreference};
...
impl D3d12VideoDecoder {
    ...
    #[allow(
        ...
        reason = "mirrors mediaway_decoder::VideoDecoder::poll_frame's Result shape for \
    ...
    #[allow(
        ...
        reason = "mirrors mediaway_decoder::VideoDecoder::flush's Result shape for a \
