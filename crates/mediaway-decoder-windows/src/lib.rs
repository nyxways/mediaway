...
//!
//! - [`VideoOutputPreference::ZeroCopyGpu`](mediaway_decoder::VideoOutputPreference): hardware
//!   H.264 decoder MFT + DXGI output surfaces (requires `gpu_device`).
//! - [`VideoOutputPreference::CpuFramesOk`](mediaway_decoder::VideoOutputPreference): software
