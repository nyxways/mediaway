...
use super::{
    Dpb, DpbError, DpbSlot, H264_MAX_DPB_SLOTS, compute_frame_num_wrap, default_ref_pic_list0,
...
#[test]
fn default_ref_pic_list0_empty_when_dpb_empty() {
    let dpb = Dpb::new(4);
    assert!(default_ref_pic_list0(&dpb).is_empty());
}
