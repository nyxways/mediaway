...
impl WindowsWasapiCapture {
    ...
    pub fn open_microphone(
        config: &mediaway_device_audio::AudioCaptureConfig,
...
impl mediaway_device_audio::AudioCapture for WindowsWasapiCapture {
...
/// non-`WASAPI` [`mediaway_device::DeviceId`]. [`CaptureError::InvalidInput`]
...
///
/// `pub`: reused by `mediaway_device_windows::enumeration`.
///
