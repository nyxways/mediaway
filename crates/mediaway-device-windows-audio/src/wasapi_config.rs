...
//! render-endpoint loopback, process loopback) since [`crate::WindowsWasapiCapture`]'s
...
//! type into this one before calling [`crate::WindowsWasapiCapture::open`].
...
/// Audio capture endpoint selection — every source [`crate::WindowsWasapiCapture`] can open.
...
/// Parameters for opening a [`crate::WindowsWasapiCapture`] session.
