...
//! ([`WindowsWindowCapture`]) — both implement `mediaway_device_desktop::DesktopVideoCapture`
//! — and desktop audio (loopback / process-loopback) via
//! [`WindowsDesktopAudioCapture`] — implements `mediaway_device_desktop::DesktopAudioCapture`
