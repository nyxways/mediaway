...
use mediaway_device::{CaptureError, DeviceEvent, DeviceHotplug, DeviceId, DeviceKind};
...
use mediaway_device_windows_audio::ComGuard;
...
/// pays per call ([`crate::enumeration::enumerate`]).
///
...
/// [`close`](DeviceHotplug::close). Unlike [`crate::WindowsWasapiCapture`]/
/// [`crate::WindowsWasapiPlayback`], this type does not spawn a worker
