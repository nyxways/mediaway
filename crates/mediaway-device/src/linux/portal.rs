...
/// [`SourceType::Monitor`] for [`crate::linux::screencast::LinuxScreenCapture`],
/// [`SourceType::Window`] for [`crate::linux::window::LinuxWindowCapture`]. Both
...
/// this shows no consent dialog. Used for [`crate::linux::capabilities::support`],
/// not [`crate::linux::capabilities::request_permission`].
///
/// # Errors
///
