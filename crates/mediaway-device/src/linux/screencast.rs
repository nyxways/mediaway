...
use crate::linux::format::map_spa_video_format;
use crate::linux::portal::{self, PortalStream};
...
/// [`crate::linux::window::LinuxWindowCapture`] — the portal `ScreenCast` +
...
/// [`crate::linux::window::LinuxWindowCapture::open`]. Callers validate their own
...
impl Session {
    ...
    /// [`crate::linux::window::LinuxWindowCapture`] both delegate their
