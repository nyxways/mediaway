...
//! plumbing as [`crate::linux::screencast`], requesting
...
///
/// See [`crate::linux::screencast::LinuxScreenCapture`] for the shared Zero-Copy
...
impl LinuxWindowCapture {
    ...
    /// [`CaptureOutputPreference::ZeroCopyGpu`](crate::desktop::CaptureOutputPreference::ZeroCopyGpu)
    /// (see [`crate::linux::screencast::LinuxScreenCapture`] docs). Returns other
