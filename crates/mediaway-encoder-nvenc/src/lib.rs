...
//!
//! - [`VideoInputPreference::CpuUploadOk`](mediaway_encoder::VideoInputPreference): H.264 /
...
impl NvencVideoEncoder {
    ...
    /// mediaway_encoder::VideoInputPreference::CpuUploadOk); NVENC has no VP9 encoder at
