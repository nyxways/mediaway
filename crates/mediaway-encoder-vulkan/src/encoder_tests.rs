...
//! reusable, multi-frame `mediaway_encoder::VideoEncoder` impl (as opposed
...
use crate::VulkanVideoEncoder;
use crate::nal::{scan_nal_headers, scan_nal_headers_hevc, scan_obu_headers};
