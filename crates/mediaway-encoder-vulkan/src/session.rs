...
//! [`h264_params`](crate::h264_params) for the `StdVideoH264*` construction
//! it feeds.
//!
...
impl Capabilities {
    ...
    /// [`encode_synthetic_intra_frame`](crate::session_encode::encode_synthetic_intra_frame)
    /// never needed (it always used [`Self::min_coded_extent`] directly, which
    /// is trivially in-range) but a real multi-resolution
    /// [`crate::encoder::VulkanVideoEncoder`] does.
