...
//!
//! - [`VideoInputPreference::CpuUploadOk`](mediaway_encoder::VideoInputPreference): sync inbox
//!   H.264 MFT + `upload_cpu_nv12` (copy); HEVC/AV1/VP9 via enumerated MFTs when present.
//! - [`VideoInputPreference::ZeroCopyGpu`](mediaway_encoder::VideoInputPreference): hardware MFT +
...
mod tests {
    ...
    fn auto_open_gpu_copy_via_d3d12_bridge_or_skip() {
        use crate::auto::AutoVideoEncoder;
...
mod audio_tests {
    ...
    use mediaway_encoder::AudioEncoderConfig;
