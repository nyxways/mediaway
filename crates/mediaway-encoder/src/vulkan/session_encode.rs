...
/// [`crate::vulkan::encoder::VulkanVideoEncoder::push_frame`] can `vkResetCommandBuffer`
...
/// only `BITSTREAM_BYTES_WRITTEN` — lets [`crate::vulkan::session_command::record_video_coding`]
...
/// [`crate::vulkan::encoder::VulkanVideoEncoder`].
...
/// [`crate::vulkan::session_command::record_and_submit`] call on the same session —
/// see [`crate::vulkan::encoder::VulkanVideoEncoder`].
