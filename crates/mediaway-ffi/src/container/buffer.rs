...
// `crate::container::buffer::{borrow_slice, leak_boxed_slice}` unchanged (muxer.rs/demuxer.rs).
...
pub(crate) use crate::common::buffer::{borrow_slice, leak_boxed_slice, reclaim_boxed_slice};
#[cfg(feature = "demux")]
use crate::container::types::{MediawayPacket, MediawayStreamInfo};

/// Free a buffer returned by [`crate::container::mediaway_muxer_poll_bytes`].
///
/// # Safety
///
...
/// Free a packet returned by [`crate::container::mediaway_demuxer_poll_packet`].
///
...
/// Free stream info returned by [`crate::container::mediaway_demuxer_stream_at`].
///
