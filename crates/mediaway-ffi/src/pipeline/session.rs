...
use crate::pipeline::types::{MediawayVideoFrame, MediawayVideoFrameStorageKind};
...
/// call [`mediaway_auto_encoder_close`](crate::pipeline::mediaway_auto_encoder_close) on
/// it afterward (double-free).
///
/// # Safety
///
/// `encoder` must be a live pointer returned by
/// [`mediaway_auto_encoder_open`](crate::pipeline::mediaway_auto_encoder_open) and not
...
/// [`mediaway_auto_encoder_close`](crate::pipeline::mediaway_auto_encoder_close). In the
