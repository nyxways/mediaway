...
use mediaway_device::desktop::{DesktopAudioCaptureConfig, DesktopVideoCaptureConfig};

use super::{DesktopAudio, WindowCapture};
...
fn desktop_audio_opens_process_loopback_as_the_concrete_backend() {
    use mediaway_device::desktop::ProcessTreeScope;
