...
| [../license/sw-opus](../license/sw-opus.md) | `mediaway-sw-opus` — real Opus decode via `unsafe-libopus`, platform-independent alternative to the unwired WMF `CMSOpusDecMFT` path |
