...
| [windows-decode-d3d12-hevc](../platform/windows-decode-d3d12-hevc.md) | D3D12 HEVC decode ADR-0004 — **implemented, sans-io-verified only** (42 unit tests, clean check/clippy), single-forward-reference P-slice scope; zero real GPU hardware verification, deliberately — do not run either D3D12 decode hardware test |
