...
| [../platform/apple-decode](../platform/apple-decode.md) | `mediaway-decoder::apple`: `VTDecompressionSession` H.264 general-GOP CPU-output decode — **ADR only**, zero compile verification; VideoToolbox owns the DPB + display-order reorder internally |
