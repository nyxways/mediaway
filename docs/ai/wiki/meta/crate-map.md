...
| `mediaway-ffi` | shared internal helper (rlib-only, no C ABI) | `Rational`/`CodecKind`/`GpuDeviceHandle`/`GpuBufferHandle` `#[repr(C)]` mirrors + buffer leak/reclaim helpers, consumed by the `*-ffi` crates ([ADR-0015](../../../adr/0015-common-ffi-unification.md); GPU handles: [device-ffi ADR-0003](../../../../crates/mediaway-ffi/adr/0003-gpu-handle-c-abi.md)) |
...
| `mediaway-ffi` | C ABI | third `*-ffi` crate; Camera video + Microphone/Loopback/ProcessLoopback audio capture, Screen/Window deferred ([ADR](../../../../crates/mediaway-ffi/adr/0001-capture-c-abi.md)) |
